...
const Footer: React.FC = () => {
	return (
		<footer className="border-t bg-[#F4F1EE]">
			<Container className="flex items-center justify-between py-8">
				...
				<div className="flex-1 mx-8">
					<ul className="text-sm text-gray-700 space-y-1">
						<li>
							Телефон:{' '}
							<a href="tel:+71234567890" className="text-primary-600">
								+7 (123) 456-78-90
							</a>
						</li>
						<li>
							Email:{' '}
							<a href="mailto:info@dodo.example" className="text-primary-600">
								info@dodo.example
							</a>
						</li>
						<li>Адрес: г. Москва, ул. Пиццы, 1</li>
					</ul>
				</div>
				...
				<div>
					<Link
						href="/about"
						className="inline-block bg-[#FF6900] text-white px-4 py-2 rounded-md font-medium hover:opacity-95">
						О нас
					</Link>
				</div>
			</Container>
